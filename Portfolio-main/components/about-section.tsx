    ...
    />
          ...
          >
            ...
            <p className="text-muted-foreground">
             As a college student passionate about technology, I started my journey with Data Structures and Algorithms (DSA), which laid the foundation for my problem-solving and analytical skills. This naturally led me to explore the world of web development and artificial intelligence.
            </p>
            <p className="text-muted-foreground">
            ...
            >
              <Button asChild>
                <Link href="https://drive.google.com/file/d/1gBTjU52TtZCll2uUiD0OpDEtLAqI-2Is/view" target="_blank" rel="noopener noreferrer">
