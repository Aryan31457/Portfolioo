...
const experiences = [
  {
    ...
    company: "VarsityPro.Club",
    logo:"/vp.png",
    location: "Hybrid",
    period: "Jan 2025 - May 2025",
    description: "Assisted in developing Software for the company, focusing on back-end development .",
    achievements: [
      "Collaborated in team to implement a new feature that improved response time and security",
      "Engineered REST APIs with Django Rest Framework to handle data requests efficiently for 1000 + users.",
      "Implement Celery for background processing, reducing response times by 30%.",
      "Apply DSA concepts for reducing and managing complex data structure",
      "Drafted API documentation for 15+ endpoints and automated datacollection via Python web scrapers.",
      "Applied industry best practices for writing clean, modular code, structuring projects ,efficiently, and utilizing Docker for containerization."
    ],
    skills: ["Python", "Django","HTML","JavaScript", "Git", "Webscraper", "DSA"]
  }
  // {
  //   id: 2,
